            ...
            return (
                ...
                >
                    <SheetContent
                        ...
                        data-mobile="true"
                        className="text-sidebar-foreground w-[--sidebar-width] bg-zinc-800 p-0 [&>button]:hidden"
                        style={{
...
const SidebarInput = React.forwardRef(({ className, ...props }, ref) => {
    return (
        <Input
            ...
            data-sidebar="input"
            className={cn(
                'focus-visible:ring-sidebar-ring h-8 w-full bg-white shadow-none focus-visible:ring-2',
                className,
            )}
            {...props}
        />
