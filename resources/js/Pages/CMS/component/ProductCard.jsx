import { Calendar, Edit, ImageIcon, Tag, Trash2 } from 'lucide-react';
        ...
        <div className="overflow-hidden rounded-lg border bg-white shadow-sm">
            ...
            <div className="flex items-center justify-between border-b bg-gray-50 px-4">
                ...
                <div className="flex space-x-2">
                    ...
                    <button
                        onClick={() => onUploadThumbnail(product)}
                    ...
                    <button
                        ...
                        className="rounded-md p-1.5 text-gray-500 transition-colors hover:bg-purple-50 hover:text-purple-600"
                        title="Upload images"
                    >
                        <BsImages />
                    </button>
                ...
                <div className="flex-grow border-t p-4 md:border-l md:border-t-0">
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
                        ...
                        <div className="rounded-md bg-gray-50 p-3">
                            <h3 className="mb-2 flex gap-1 text-xs font-medium uppercase text-gray-500">
